import logging.handlers, asyncio, threading, requests, subprocess, os, logging, sys, signal
...
async def debug():
    ...
    Paperless(app.config['PAPERLESS_BASE_URL'].rstrip('/api'), app.config['AUTH_TOKEN'])
